...
/**
 * A generic undo/redo implementation for EditText.
 */
public class EditTextUndoRedoUtil {
	...
	/**
	 * Create a new EditTextUndoRedoUtil and attach it to the specified TextView.
	 * 
	 * @param editText
	 *            The text view for which the undo/redo is implemented.
	 */
	public EditTextUndoRedoUtil(EditText editText) {
		mEditText = editText;
