...
public class GPUImageFilterTools {
    private static final FilterList filters = new FilterList();
...
//        filters.addFilter("Color Balance", FilterType.COLOR_BALANCE);
    ...
    private static String[] getFilterNameList()
    {

return filters.names.toArray(new String[filters.names.size()]);
    }
